<template>
  ...
  <div class="wrapper">
    ...
    <div class="banner">
      <img class="banner__img" :src="https://cn.bing.com/images/search?q=%E5%95%86%E5%93%81%E5%9B%BE%E7%89%87&FORM=IQFRBA&id=440EF1A5DD13C30F624CBD9B33918E1C240A0186" />
    </div>
  </div>
  <!-- docker层 -->
  <div class="docker">
