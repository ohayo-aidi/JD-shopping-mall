  ...
  <div class="wrapper">
    ...
    <div class="icons">
      ...
      <div class="icons__item">
        ...
        />
        <p class="icons__item__desc">菜市场场</p>
      </div>
      <div class="icons__item">
        <img
          class="icons__item__img"
        ...
        />
        <p class="icons__item__desc">水果店铺</p>
      </div>
      <div class="icons__item">
        <img
          class="icons__item__img"
        ...
        />
        <p class="icons__item__desc">鲜花市场</p>
      </div>
      <div class="icons__item">
        <img
          class="icons__item__img"
    ...
    <div class="nearby">
      ...
      <div class="nearby__item">
        <img class="nearby__item__img" src=""/>

        <div class="nearby__item__content">
          <div class="nearby__item__content__title"></div>
          <div class="nearby__item__content__tags">
          <span class="nearby__item__content__tag"></span>
          <span class="nearby__item__content__tag"></span>
          <span class="nearby__item__content__tag"></span>
          </div>
          <p class="nearby__item__content__highlight"></p>
        </div>
      </div>
    </div>
  </div>
